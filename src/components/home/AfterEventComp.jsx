            ...
            <div className="after-event-container">
                ...
                <div className="after-event-row">
                    ...
                    <div className="tes-vidio">
                        <iframe className="mt-5"  width="100%" height="315" src="https://www.youtube.com/embed/qUYhvRX0VWE?si=m3H7xJhH7h7uNCXF" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                    </div>
